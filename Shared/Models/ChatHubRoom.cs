...
namespace Oqtane.ChatHubs.Models
{
    public class ChatHubRoom : ChatHubBaseModel
    {
        ...
        [NotMapped] public virtual ICollection<ChatHubUser> Users { get; set; }
        [NotMapped] public virtual ICollection<ChatHubRoomChatHubModerator> RoomModerators { get; set; }
        [NotMapped] public virtual ICollection<ChatHubModerator> Moderators { get; set; }
        [NotMapped] public virtual ICollection<ChatHubRoomChatHubWhitelistUser> RoomWhitelistUsers { get; set; }
        [NotMapped] public virtual ICollection<ChatHubWhitelistUser> WhitelistUsers { get; set; }
        ...
        [NotMapped] public virtual ICollection<ChatHubViewer> Viewers { get; set; }
